...
```
/knowledge add e-commerce-developer myknowledge.md
```
...
>[!NOTE]
>바이브코딩을 이용한 웹서비스 구축 파일 생성에는 시간이 약 10-15분 정도 소요될 수 있습니다. 다음은 Kiro CLI를 이용해서 구현된 웹 애플리케이션 코드의 예입니다.
>
...
다음 실습을 위해 아래 링크로 이동하세요.

[![Next](../03.mcp-server/images/next.png)](../01.kiro-cli-begin/lab2.Kiro_CLI_mcp.md)
