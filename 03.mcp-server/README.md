...
![mcp](https://github.com/noenemy/kiro-cli/blob/main/03.mcp-server/images/mcp.jpg)
...
- [Modelcontext.io - Weather MCP Server](https://github.com/noenemy/kiro-cli/blob/main/03.mcp-server/01.weather-mcp-server.md)
<BR><BR>

## Lab.3-2. Streamable-HTTP MCP Server & MCP Client/MCP Host
- [Remote Weather MCP Server, MCP Client, MCP Host](https://github.com/noenemy/kiro-cli/blob/main/03.mcp-server/02.mcp-host_mcp-client.md)
<BR><BR>

### 참조
AWS MCP Server : [AWS MCP Server](https://github.com/noenemy/kiro-cli/blob/main/03.mcp-server/AWS-MCP-Server.md)
